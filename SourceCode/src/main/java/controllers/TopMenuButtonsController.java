...
import database.dao.SectionDao;
...
public class TopMenuButtonsController {
	...
	public void setPolish() {
		...
		// System.out.println(getSectionList().get(0).getName());

	}
	///////////

	public void saveCategoryInDataBase(String name) throws ApplicationException {
		SectionDao sectionDao = new SectionDao(DbManager.getConnectionSource());
		Section section = new Section();
		section.setName(name);
		// System.out.println(category.getName());
		sectionDao.creatOrUpdate(section);
	...
	public void setTextFields() {
		...
		mainController.getDesignDataController().getTextArea()
				.setText(textAreaClass + " " + Double.toString((calculator_sectionClass.klasa_przekroju)));
	...
	public void setLanguage() {
		...
		setLabelLanguage(mainController.getCalculationsDataController().getLabelYYNosnoscKrytyczna(),
				"calculations.YYNosnoscKrytyczna");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelYYSmukloscWzgledna(),
				"calculations.YYSmukloscWzgledna");
		...
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZMomentZginajacy(),
				"calculations.ZZMomentZginajacy");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZNosnoscScinanie(),
				"calculations.ZZNosnoscScinanie");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZNosnoscZginanie(),
				"calculations.ZZNosnoscZginanie");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZSilaKrytyczna(),
				"calculations.ZZSilaKrytyczna");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZSilaPodluzna(),
				"calculations.ZZSilaPodluzna");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZSilaPoprzecznaPas(),
				"calculations.ZZSilaPoprzecznaPas");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZSilaPoprzecznaSlup(),
				"calculations.ZZSilaPoprzecznaSlup");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZSztywnosc(),
				"calculations.ZZSztywnosc");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelZZWarunkiNosnosci(),
				"calculations.ZZWarunkiNosnosci");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelTitleZZ(), "calculations.TitleZZ");

		setLabelLanguage(mainController.getCalculationsDataController().getLabelPlateMoment(),
				"calculations.PlateMoment");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelPlateNosnoscScinanie(),
				"calculations.PlateNosnoscScinanie");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelPlateNosnoscZginanie(),
				"calculations.PlateNosnoscZginanie");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelPlateSilaPoprzeczna(),
				"calculations.PlateSilaPoprzeczna");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelPlateWarunekScinanie(),
				"calculations.WarunekScinanie");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelPlateWarunekZginanie(),
				"calculations.TitleZZ");
		setLabelLanguage(mainController.getCalculationsDataController().getLabelTitlePlate(),
				"calculations.WarunekZginanie");
